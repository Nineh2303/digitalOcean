"""
Django settings for PhotoGear project.
...
WSGI_APPLICATION = 'PhotoGear.wsgi.application'
...
cloudinary.config( 
  ...
  api_secret = "1bP7LftE_XUBk_ctFLzK2UCDw2U",
)

try: 
    from .configs import jwt_config
except :
    pass